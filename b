...
function VerificarPlayer(SenhaCodificada)
	...
	if HWID and ipAddress then
		...
		local tfl = SenhaCodificada:sub(52 + #RemoveTHwid - 10, #ipAddress - 4)
		...
		print("Comparando t52:", t52, "com RemoveTHwid restante:", RemoveTHwid:sub(10, #RemoveTHwid))
		...
		return (
			...
			emLista(t10, {"S", "3", "X", "Y"}) and
				...
				tostring(t52) == tostring(RemoveTHwid:sub(10, #RemoveTHwid)) and
